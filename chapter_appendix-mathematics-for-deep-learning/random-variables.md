...
우선, 한 자릿수의 정확도, 즉 $0 \text{cm}$, $1 \text{cm}$, $2 \text{cm}$ 등에 대한 빈을 측정하는 것을 상상합니다.우리는 다트 보드에 $100$ 개의 다트를 던지고, 그 중 $20$ 개가 $2\text{cm}$의 빈에 떨어지면 중앙에서 $20\%$ of the darts we throw hit the board $2\text{cm}$ 떨어져 있다고 결론을 내립니다. 
